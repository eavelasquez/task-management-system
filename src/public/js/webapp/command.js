      ...
      case Commands.ADD:
        ...
        if (activityTitle !== "" && activityDate && activityTime) {
          const activityData = {
            ...
            capacity: DOM.activityCapacity.value ? Number.parseInt(DOM.activityCapacity.value) : null,
          ...
          try {
            ...
            // Update local list
            const activity = new Activity(newActivity.type, newActivity.title, newActivity.date, newActivity.time)
      ...
      case Commands.UPDATE:
        ...
        if (activity) {
          ...
          if (activityTitle !== "" && activityDate && activityTime) {
            ...
            try {
              const updatedActivity = await ApiService.updateActivity({ ...activity, ...data })
              // Update local list
